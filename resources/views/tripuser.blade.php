...
<body id="page-top" class="index">
    ...
    <!-- Navigation -->
    <nav id="mainNav" class="navbar navbar-default navbar-search navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="index.html">Up To Train</a>
            </div>
        ...
        <div class="container">
            <div>
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">กรุงเทพ-ลพบุรี</h2>
                    <h3 class="section-subheading text-muted">ทริปที่เกี่ยวข้อง</h3>
                </div>
            </div>
            <div class="row">
